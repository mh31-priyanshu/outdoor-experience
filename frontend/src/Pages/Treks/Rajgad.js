...
import { RajgadTrekInfo } from "../../Components/TrekInfo/Rajgad/RajgadTrekInfo";
import { RajgadBooking } from "../../Components/TrekInfo/Rajgad/RajgadBooking";
    ...
    return <div className="select-none">
        <div className="h-screen w-full flex pt-6 pl-12 pr-3 -mt-3">
            ...
            <div className="w-1/2">  
                ...
                {showTrekInfo?(
                    <RajgadTrekInfo></RajgadTrekInfo>

                ):(
                    <RajgadBooking></RajgadBooking>
                )}
                {showTrekInfo?(
            ...
            <div className="w-1/2 h-full">
                <img className="object-cover h-full w-full rounded-3xl" src={require("../../assets/treks/RajGad.jpg")} alt="" />
            </div>
        </div>
    </div>
}